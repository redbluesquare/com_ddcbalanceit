		...
		<div class="col-xs-12">
			...
			<div id="account_info" class="collapse out">
				<table  class="col-xs-8">
					...
					<tr><td class="col-xs-7"><b><?php echo JText::_('COM_DDC_ACCOUNT_NUMBER');?></b></td><td class="col-xs-5"><?php echo $this->item->account_number;?></td></tr>
...
<div id="targetModal" class="modal hide fade">
  ...
  <div class="modal-body">
    ...
    <table class="table">
		<tbody>
			<tr>
				<th class="col-xs-5"><?php echo JText::_('COM_DDC_ID'); ?></th>
				<td class="col-xs-7"><?php echo $this->item->ddcbi_account_id;  ?></td>
			</tr>
			<tr>
				<th><?php echo JText::_('COM_DDC_ACCOUNT_NAME'); ?></th>
				<td><?php echo $this->item->account_name; ?></td>
